...
class TestBasic:
    ...
    def test_import_serverextension(self):
        ...
        from jupyter_system_usage import (
        ...
        with patch("tornado.ioloop.PeriodicCallback") as periodic_callback_mock, patch(
            "jupyter_system_usage.server_extension.ResourceUseDisplay"
        ) as resource_use_display_mock, patch(
            "jupyter_system_usage.server_extension.PrometheusHandler"
        ) as prometheus_handler_mock, patch(
            "jupyter_system_usage.server_extension.PSUtilMetricsLoader"
            ...
            assert (
                "jupyter_system_usage_display_config" in nbapp_mock.web_app.settings
            )
